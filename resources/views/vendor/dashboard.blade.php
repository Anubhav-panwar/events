    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ $hasVendorEventsCreateRoute ? route('vendor.events.create') : url('/vendor/events/create') }}" class="btn-primary text-sm">
                ...
                <a href="{{ $hasVendorOrdersRoute ? route('vendor.orders.index') : url('/vendor/orders') }}" class="btn-secondary text-sm">
                ...
                <a href="{{ $hasVendorCheckinRoute ? route('vendor.checkin.form') : url('/vendor/checkin') }}" class="btn-secondary text-sm">
    ...
    <section class="page-section">
        <div class="app-content max-w-6xl space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                <a href="{{ $hasVendorProfileRoute ? route('vendor.profile.edit') : url('/vendor/profile') }}" class="surface p-5 text-center card-hover block border border-slate-200 hover:border-slate-400">
                ...
                <a href="{{ $hasVendorOrdersRoute ? route('vendor.orders.index') : url('/vendor/orders') }}" class="surface p-5 text-center card-hover block border border-slate-200 hover:border-slate-400">
                ...
                <a href="{{ $hasVendorCheckinRoute ? route('vendor.checkin.form') : url('/vendor/checkin') }}" class="surface p-5 text-center card-hover block border border-slate-200 hover:border-slate-400">
                ...
                <a href="{{ $hasVendorsIndexRoute ? route('vendors.index') : url('/vendors') }}" class="surface p-5 text-center card-hover block border border-slate-200 hover:border-slate-400">
